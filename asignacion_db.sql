...
CREATE TABLE flokzu (
	flokzu	INTEGER NOT NULL UNIQUE,
	matricula_id	INTEGER,
	FOREIGN (KEYmatricula_id) REFERENCES Asignacion(Matricula)
);
...
CREATE TABLE IF NOT EXISTS crm (
	...
	matricula_id	INTEGER,
	identificador_id	INTEGER,
	FOREIGN KEY(matricula_id) REFERENCES Asignacion(Matricula),
	FOREIGN KEY(identificador_id) REFERENCES nombre_del_agente(identificador),
